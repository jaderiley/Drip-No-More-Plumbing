...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Drip No More Plumbing",
    phone:     "+27 11 673 9184",
    whatsapp:  "+27 11 673 9184",
    address:   "53 Tucker St, Alberton, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Drip No More Plumbing — Plumber in alberton",
    description: "Drip No More Plumbing provides professional plumber in Alberton. 1 Google review. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Plumber · Alberton & surrounds",
    heroTitle:  "Burst pipe? Blocked drain? <em>We will fix it fast.</em>",
    heroLead:   "Drip No More Plumbing provides fast, reliable plumbing services for homes and businesses across Alberton and the surrounding areas. Emergency callouts welcome.",
    ...
    band: {
      ...
      alt:   "Drip No More Plumbing team at work in Alberton",
      text:  "Fast, reliable plumbing — emergency callouts welcome."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Alberton. Serving the wider area.",
    areasLead:  "We cover Alberton, Johannesburg, Randburg and the surrounding suburbs. Emergency callouts available throughout the area.",
